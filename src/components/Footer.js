            ...
            <div className="div1">
                <div  className="div2">
                    ...
                    <span className="icons">
                        ...
                        <a href="https://twitter.com/cwyclub?s=11&t=IqihoiFojWyBDZKVR0gXIQ" target="blank" style={{color: 'rgb(107 114 128)'}} className="ml-3 cursor-pointer">
                            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="icon-size" viewBox="0 0 24 24">
                                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                            </svg>
                        </a>
                        <a href="https://instagram.com/cryptowhalesyachtclub?igshid=YmMyMTA2M2Y=" target="blank" style={{color: 'rgb(107 114 128)'}} className="ml-3 cursor-pointer">
